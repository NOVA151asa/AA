              ...
              <div class="card-body box-profile">
                <div class="row">
                  ...
                  <div class="col-sm-12 mb-1">
                    <button type="button" onclick="open_modal_edit('<?=$row['p_id']?>','<?=$row['p_title']?>','<?=$row['p_detail']?>','<?=$row['p_type']?>','<?=$row['p_reward']?>','<?=$row['p_transfer_min']?>','<?=$row['p_deposit_day']?>','<?=$row['p_turnover']?>','<?=$row['p_turnover_type']?>','<?=$row['p_withdraw_max']?>','<?=$row['p_status']?>','<?=$row['p_img']?>')" class="btn btn-success btn-block">
...
<script type="text/javascript">
  ...
  function open_modal_edit(p_id,p_title,p_detail,p_type,p_reward,p_transfer_min,p_deposit_day,p_turnover,p_turnover_type,p_withdraw_max,p_status,p_img)
  {
    $("#p_img").val(p_img);
    $("#p_title").val(p_title);
