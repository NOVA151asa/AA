...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed text-sm">
  ...
  <tr>
    <td><div align="center">ลำดับขั้นชวนเพื่อน</div></td>
    <td>
      <input name="aff_step" id="aff_step" min="1" max="3" type="text" class="form-control" value="<?php echo $row_u['aff_step']; ?>" size="20">
    </td>
    <td colspan="2"><div align="center" class="style1">ตั้งค่าอื่นๆ</div></td>
  </tr>
  <tr>
    ...
    <td><div align="center">เปิด/ปิด คืนยอดเสีย</div></td>
    <td>
  ...
  <tr>
    <td><div align="center">% ชวนเพื่อน ขั้น 2</div></td>
    ...
    <td><div align="center">เปิด/ปิด เช็คอินรายวัน</div></td>
    <td>
  ...
  <tr>
    <td><div align="center">% ชวนเพื่อน ขั้น 3</div></td>
    ...
    <td><div align="center">เปิด/ปิด แนะนำเพื่อน</div></td>
    <td>
  ...
  <tr>
    <td><div align="center">ประเภทรายได้ที่คิดค่าแนะนำ</div></td>
    <td>
    ...
    <td><div align="center">เปิด/ปิด เติมเครดิตฟรี</div></td>
    <td>
  ...
  <tr>
    <td><div align="center">ถอนค่าแนะนำแบบติดโปร <span class="badge badge-success">New</span></div></td>
    <td>
  ...
  <tr>
    ...
    <td colspan="2"><div align="center" class="style1">ตั้งค่า SMS</div></td>
  </tr>
  <tr>
    ...
    <td><div align="center">เปิด/ปิด SMS OTP</div></td>
    <td>
  ...
  <tr>
    ...
    <td><div align="center">User THSMS</div></td>
    <td><input name="sms_user" id="sms_user" type="text" class="form-control" value="<?php echo $row_u['sms_user']; ?>" size="20"></td>
  </tr>
  <tr>
    ...
    <td><div align="center">Password THSMS</div></td>
    <td><input name="sms_pass" id="sms_pass" type="text" class="form-control" value="<?php echo $row_u['sms_pass']; ?>" size="20"></td>
  </tr>
