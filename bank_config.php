...
<!------------------------------------------------------------------------------------>
          <div class="col-sm-4">
			...
			<input type="hidden" class="form-control" id="txt_bay_username" value="<?=$row_bay['a_bank_username']?>">
			<input type="hidden" class="form-control" id="txt_bay_password" value="<?=$row_bay['a_bank_password']?>">
                  </div>
                </div>
              </div>
            </div>
