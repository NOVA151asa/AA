  ...
  <div class="sidebar">
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="info">
        ...
        <br>
        <?php 
          $q_deposit = dd_q('SELECT * FROM autobank_tb WHERE (a_bank_code = ?)', ['scb']);
          $row_bankdeposit = $q_deposit->fetch(PDO::FETCH_ASSOC);
        ?>
        <span>ระบบ : <?php if ($row_bankdeposit['a_bank_status'] == "1"){echo "ฝากออโต้ : <span style='color:#00ff08'>เปิด</span>";}else{echo "ฝากออโต้ : <span style='color:red;'>ปิด</span>";}?></span>
        <br>
        <?php 
